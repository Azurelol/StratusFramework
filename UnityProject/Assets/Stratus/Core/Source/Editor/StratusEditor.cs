...
namespace Stratus
{
  ...
  public abstract class StratusEditor : UnityEditor.Editor
  {
    ...
    // Virtual Methods
    //------------------------------------------------------------------------/
    protected abstract void OnBaseEditorEnable();
    protected virtual void OnFirstUpdate() { }
    internal abstract void OnGenericBaseEditorEnable();
    internal abstract void OnGenericBaseEditorValidate();
  ...
  public abstract class BehaviourEditor<T> : StratusEditor where T : MonoBehaviour
  {
    ...
    protected virtual void OnBaseEditorValidate() { }
    ...
    internal override void OnGenericBaseEditorValidate()
    {
      if (target)
        OnBaseEditorValidate();
    }
