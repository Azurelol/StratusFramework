    ...
    */
    ...
    void StartSlideshow()
    {
      ...
      foreach (var slide in Slides)
      {
        ...
        Actions.Property(seq, () => graphical.color, Color.white, durationForEach, Ease.Linear);
        Actions.Call(seq, this.AdvanceSlide);
        Actions.Property(seq, () => graphical.color, Color.clear, durationForEach, Ease.Linear);
      }
    ...
    void End()
    {
      if (TriggerOnEnd)
      {
        this.gameObject.Dispatch<EventTrigger.TriggerEvent>(new EventTrigger.TriggerEvent());
      }
    }
