...
{
	public class StratusStoryEvent : StratusTriggerable
	{
		public enum Scope
		{
		...
		[DrawIf(nameof(StratusStoryEvent.queue), true, ComparisonType.Equals)]
		...
		// Properties
		//------------------------------------------------------------------------------------------/
		private StratusStory.LoadEvent storyEvent => new StratusStory.LoadEvent()
		{
