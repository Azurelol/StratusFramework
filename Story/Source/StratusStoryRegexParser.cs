...
namespace Stratus.Gameplay.Story
{
	...
	/// </summary>
	public class StratusStoryRegexParser : Parser
	{
		//--------------------------------------------------------------------/
		// Definitions
		//--------------------------------------------------------------------/
		...
		{
			public Category(string label, string pattern, Target target, System.Action<StratusStoryParse> onParse, Scope scope)
			{
				this.label = label;
			...
			/// </summary>
			public System.Action<StratusStoryParse> onParse { get; private set; }
		...
		public void AddPattern(string label, string groupPattern, Target target, Scope scope, System.Action<StratusStoryParse> onParseSuccessful = null)
		{
		...
		public static class Presets
		{
			...
			/// Speaker : Message
			/// </summary>
			public static string beforeColon { get; } = ComposeSeparatorLeftCapture(':');
			...
			/// <summary>
			/// Composes a regular expresion that captures the contents of a string before
			/// the separating character
			/// </summary>
			/// <param name="separator"></param>
			/// <returns></returns>
			public static string ComposeSeparatorLeftCapture(char separator)
			{
				return $@"^.*?(?={separator})";
			}
