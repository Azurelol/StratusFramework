...
namespace Stratus.Gameplay.Story
{
	...
	public class StratusStory
	{
		...
		/// </summary>
		public class PresentChoicesEvent : StratusEvent
		{
			public StratusStoryChoice[] choices { get; set; }
		}
		...
		{
			public StratusStoryChoice choice;
		}
		...
		/// </summary>
		public class UpdateLineEvent : StratusEvent
		{
			/// <summary>
