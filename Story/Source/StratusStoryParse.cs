...
namespace Stratus.Gameplay.Story
{
	...
	/// </summary>
	public class StratusStoryParse
	{
		public StratusStoryParse(string label)
		{
			this.label = label;
		}
		...
		/// <summary>
		/// The value of this parse (first value if grouped)
		/// </summary>
	...
	{
		private Dictionary<string, StratusStoryParse> parses;

		public ParsedLine(Dictionary<string, StratusStoryParse> parses, List<string> tags, string line)
		{
			this.parses = parses;
			this.line = line;
			this.tags = tags;
		...
		/// <param name="parseCategory"></param>
		/// <returns></returns>
		public StratusStoryParse Find(string label)
		{
