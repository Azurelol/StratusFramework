...
namespace Stratus.AI
{
		...
		public partial class Planner : StratusBehaviorSystem
		{
			//------------------------------------------------------------------------/
			// Declarations: Event
			//------------------------------------------------------------------------/      
			...
			/// </summary>
			public StratusGoal goal;

			/// <summary>
			/// The current state of this agent.
			/// </summary>
			public StratusWorldState state = new StratusWorldState();
			...
			protected override StratusAIBehavior currentBehavior => currentAction.task;
			...
			{
				this.agent.gameObject.Connect<StratusWorldState.ModifySymbolEvent>(this.OnModifySymbolEvent);
			}
			...
			/// </summary>
			/// <param name="e"></param>
			void OnModifySymbolEvent(StratusWorldState.ModifySymbolEvent e)
			{
