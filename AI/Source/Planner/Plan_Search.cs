    ...
    public partial class Plan
    {
      ...
      public class Search
      {
        ...
        public class Node
        {
          ...
          public StratusWorldState State;
        ...
        Dictionary<StratusWorldState, StatefulAction> ActionEffectsTable = new Dictionary<StratusWorldState, StatefulAction>();
        Node StartingNode, DestinationNode;
        // Planner properties
        StratusWorldState StartState;
        StratusWorldState EndState;
