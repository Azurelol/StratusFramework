...
namespace Stratus.AI
{
		...
		/// </summary>
		[Serializable]
		public abstract class StratusAIBehavior : IStratusLabeled
		{
			/// <summary>
			...
			public class Arguments
			{
				...
				public StratusBehaviorSystem system;

				public StratusBlackboard blackboard => agent.blackboard;
			}

			public class BehaviorEvent : Stratus.StratusEvent { public StratusAIBehavior behavior; }
			...
			/// The name for this behavior
			/// </summary>
			string IStratusLabeled.label => this.label;
			/// <summary>
			...
			/// <returns></returns>
			protected object GetSymbolValue(Arguments args, StratusBlackboard.SymbolReference symbol)
			{
			...
			// Static Methods
			//----------------------------------------------------------------------/
			public static StratusAIBehavior Instantiate(Type behaviorType)
			{
				if (!behaviorType.IsSubclassOf(typeof(StratusAIBehavior)))
					return null;
				return (StratusAIBehavior)Utilities.StratusReflection.Instantiate(behaviorType);
			}

			public static T Instantiate<T>() where T : StratusAIBehavior
			{
