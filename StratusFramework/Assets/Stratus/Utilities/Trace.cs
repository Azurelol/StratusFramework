...
namespace Stratus
{
  ...
  public class Trace
  {
    ...
    */
    /**************************************************************************/
    static public void Script(object obj)
    {
      StackTrace stackTrace = new StackTrace();
    ...
    /*!
    @brief  Prints the given message, prefixing it with the name of the Method,
            the Component and the GameObject it is on.
    @param  obj The message.
    @param  this A reference to the component.
    */
    /**************************************************************************/
    static public void Object(object obj, MonoBehaviour component)
    {      
      StackTrace stackTrace = new StackTrace();
      var methodName = stackTrace.GetFrame(1).GetMethod().Name;
    ...
    */
    /**************************************************************************/
    static public void Variable<T>(Expression<Func<T>> varExpr)
    {
      StackTrace stackTrace = new StackTrace();
      var methodName = stackTrace.GetFrame(1).GetMethod().Name;
      var className = stackTrace.GetFrame(1).GetMethod().ReflectedType.Name;      
    ...
    */
    /**************************************************************************/
    static public void Variable<T>(Expression<Func<T>> varExpr, MonoBehaviour component)
    {
      StackTrace stackTrace = new StackTrace();
      var methodName = stackTrace.GetFrame(1).GetMethod().Name;
      var className = stackTrace.GetFrame(1).GetMethod().ReflectedType.Name;
