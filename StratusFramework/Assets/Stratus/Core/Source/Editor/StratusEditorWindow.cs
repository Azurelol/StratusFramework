...
namespace Stratus
{
	...
	public abstract class StratusEditorWindow<T> : StratusEditorWindow where T : EditorWindow
	{
		...
		protected void EditProperties(params SerializedProperty[] serializedProperties)
		{
			...
			{
				this.EditProperty(property, property.displayName);
			}
		}

		protected bool EditProperty(SerializedProperty serializedProperty, string label)
		{
			return StratusEditorGUI.EditorGUILayoutProperty(serializedProperty, label);
		}
