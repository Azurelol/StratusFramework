...
namespace Stratus
{
  ...
  public partial class StratusSerializedSystemObject
  {
    ...
    public StratusOdinSerializedProperty[] properties { get; private set; }
    public Dictionary<string, StratusOdinSerializedProperty> propertiesByName { get; private set; }
    ...
    // CTOR
    //------------------------------------------------------------------------/
    public StratusSerializedSystemObject(Type type, object target)
    {
      this.type = type;
      this.target = target;
    ...
    public StratusSerializedSystemObject(object target)
    {
      this.drawer = GetDrawer(target.GetType());
      this.target = target;
    }

    static StratusSerializedSystemObject()
    {
    ...
    public static ObjectDrawer GetObjectDrawer(object element)
    {
      ...
      if (!objectDrawers.ContainsKey(elementType))
        objectDrawers.Add(elementType, new StratusSerializedSystemObject.DefaultObjectDrawer(elementType));
    ...
    public static FieldDrawer GetFieldDrawer(FieldInfo field)
    {
      if (!fieldDrawers.ContainsKey(field))
        fieldDrawers.Add(field, new StratusSerializedSystemObject.FieldDrawer(field));
