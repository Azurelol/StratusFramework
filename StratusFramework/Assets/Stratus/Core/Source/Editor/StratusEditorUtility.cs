...
namespace Stratus
{
	public static partial class StratusEditorUtility
	{
		...
		{
			get => Reflection.GetField<Rect>("s_LastRect", typeof(UnityEditor.EditorGUILayout));
			set => Reflection.SetField<Rect>("s_LastRect", typeof(UnityEditor.EditorGUILayout), value);
		}
		...
		{
			return Utilities.Reflection.Instantiate<T>();
		}

		public static object Instantiate(Type type)
		{
			return Utilities.Reflection.Instantiate(type);
		}
