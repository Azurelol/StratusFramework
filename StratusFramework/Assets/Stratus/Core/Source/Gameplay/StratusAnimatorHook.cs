...
namespace Stratus.Gameplay
{
  ...
  /// </summary>
  public abstract class StratusAnimatorHook
  {
    /// <summary>
  ...
  /// </summary>
  [Serializable]
  public class StratusAnimatorEventHook : StratusAnimatorHook
  {
    [ClassExtends(typeof(Stratus.StratusEvent), Grouping = ClassGrouping.ByNamespace, AllowAbstract = false)]
  ...
  /// </summary>
  [Serializable]
  public class StratusAnimatorParameterHook : StratusAnimatorHook
  {
    /// <summary>
  ...
  [Serializable]
  public class StratusAnimationParameterEvent : UnityEvent<float, bool, int> { }
