...
namespace Stratus.Gameplay
{
  ...
  public class StratusSegment : StratusBehaviour, Debuggable, ValidatorAggregator
  {
    //------------------------------------------------------------------------/
    // Declarations
    //------------------------------------------------------------------------/
    ...
    {
      public StratusSegment segment { get; protected set; }
    }
    ...
    public class EnteredEvent : BaseSegmentEvent
    {
      ...
      public EnteredEvent(StratusSegment segment)
      {
    ...
    {
      public ExitedEvent(StratusSegment segment)
      {
        this.segment = segment;
      }
    }
    ...
    [SerializeField]
    private StratusEpisode episode_;
    ...
    /// </summary>
    public static StratusSegment current { get; protected set; }
    /// <summary>
    ...
    /// </summary>
    public static Dictionary<string, StratusSegment> available { get; private set; } = new Dictionary<string, StratusSegment>();
    /// <summary>
    ...
    /// </summary>
    public static List<StratusSegment> availableList = new List<StratusSegment>();
    /// <summary>
    ...
    /// </summary>
    public StratusEpisode episode { get { return episode_; } internal set { episode_ = value; } }
    /// <summary>
    ...
    public void TranslateToCheckpoint(Transform target, int index)
    {
      ...
      {
        StratusDebug.Error($"No checkpoint available at index {index}", this);
        return;
      }
