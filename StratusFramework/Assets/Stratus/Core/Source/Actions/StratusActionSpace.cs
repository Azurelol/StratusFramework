...
namespace Stratus
{
  ...
  public class StratusActionSpace : Singleton<StratusActionSpace>
  {
    //------------------------------------------------------------------------/
    // Declarations
    //------------------------------------------------------------------------/
    public class ActionsContainer
    {
      ...
      public StratusActionsOwner owner;

      public ActionsContainer(GameObject gameObject, StratusActionsOwner owner)
      {
    ...
    /// <returns></returns>
    public static StratusActionsOwner Subscribe(GameObject gameObj)
    {
    ...
    /// <returns></returns>
    private StratusActionsOwner SubscribeToActions(GameObject gameObject)
    {
    ...
    public static void PrintActiveActions()
    {
      ...
      foreach (var action in StratusActionSpace.instance.activeActions)
      {
