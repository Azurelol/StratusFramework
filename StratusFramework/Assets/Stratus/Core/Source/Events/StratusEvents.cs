...
namespace Stratus
{
  ...
  public class StratusEvents : Singleton<StratusEvents>
  {
    ...
    static void DisconnectFromGameObject(Behaviour component, GameObject gameObj)
    {
      ...
      foreach (var pair in StratusEvents.instance.dispatchMap[gameObj])
      {
    ...
    public static void Dispatch<T>(GameObject obj, T eventObj, bool nextFrame = false) where T : StratusEvent
    {
