...
{
	public class StratusTopDownCameraController : StratusCameraControllerBase
	{
		[Header("Displacement")]
		...
		[Header("Input")]
		public StratusInputBinding horizontalAxis = new StratusInputBinding();
		public StratusInputBinding verticalAxis = new StratusInputBinding();
		public StratusInputBinding scrollAxis = new StratusInputBinding();
