...
namespace Stratus.Gameplay
{
	...
	public class EpisodeSceneDisplay : MultitonSceneViewDisplay<StratusEpisodeBehaviour>
	{
		private Dictionary<StratusSegmentBehaviour, bool> segmentExpanded;

		protected override void OnInitializeMultitonState()
		{
			segmentExpanded = new Dictionary<StratusSegmentBehaviour, bool>();

			foreach (var episode in StratusEpisodeBehaviour.instances)
			{
				foreach (var segment in episode.instance.segments)
				{
