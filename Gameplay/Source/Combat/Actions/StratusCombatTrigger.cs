...
{
	[Serializable]
	public class StratusCombatTrigger : ICloneable
	{
		//------------------------------------------------------------------------/
		// Declarations
		//------------------------------------------------------------------------/
		...
		public class Input : ICloneable
		{
			...
			/// </summary>
			public StratusCounter Presses = new StratusCounter();
			/// <summary>
			...
			object ICloneable.Clone()
			{
				var clone = new Input();
				//clone.Button = Button;
				clone.Presses = new StratusCounter(Presses.total);
				clone.Range = Range;
				return clone;
			}
		}
		...
		public class Instance
		{
			...
			/// The trigger to set
			/// </summary>
			public StratusCombatTrigger Trigger;
			/// <summary>
			/// The character this trigger is for
			/// </summary>
			public StratusCombatController Caster;
			/// <summary>
		...
		// Methods
		//------------------------------------------------------------------------/
		public StratusCombatTrigger Copy(StratusCombatTrigger rhs)
		{
			var trigger = new StratusCombatTrigger();
