  ...
  { 
    ...
    public abstract class AbstractWindow : Element
    {
      ...
      public AbstractWindow(string title, Vector2 relativeDimensions, Color color, Anchor position = Anchor.TopLeft) : base(title)
      {
        ...
        //this.TitleStyle = GUITools.Get(GUITools.Style.Title);
        //this.TitleStyle = GUI.skin.ti
        //BackgroundStyle = GUI.skin.window;
        //BackgroundStyle.normal.background = MakeTexture((int)Dimensions.x, (int)Dimensions.y, color);
      }
