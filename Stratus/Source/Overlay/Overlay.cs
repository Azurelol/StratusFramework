...
namespace Stratus
{
  ...
  public partial class Overlay : StratusSingleton<Overlay>
  {
    ...
    void Reset()
    { 
      Windows.Watch = new Window("Watch", new Vector2(0.2f, 0.1f), Color.grey, Anchor.TopLeft);      
      Windows.Buttons = new Window("Buttons", new Vector2(0.2f, 0.1f), Color.grey, Anchor.Left);
