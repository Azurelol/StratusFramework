...
namespace Stratus
{
  [CustomPropertyDrawer(typeof(TargetField))]
  public class TargetFieldDrawer : PropertyDrawer
  {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
      ...
      var type = (TargetField.Type)typeProp.enumValueIndex;
